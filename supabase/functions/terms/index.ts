...
const terms = {
  ...
  sections: [
    { title: "Acceptance of Terms", content: "By creating an account or using Nawe Wellness ('the Platform'), you agree to be bound by these Terms & Conditions." },
    { title: "Platform Overview", content: "Nawe Wellness is a therapy marketplace that connects clients with licensed therapists. We facilitate discovery, booking, and session management but do not provide therapy services directly." },
    ...
    { title: "Disclaimer of Warranties", content: "The Platform is provided 'as is' without warranties of any kind. Nawe Wellness does not guarantee the outcome of any therapy session." },
    { title: "Limitation of Liability", content: "To the maximum extent permitted by law, Nawe Wellness shall not be liable for any indirect, incidental, or consequential damages." },
    ...
    { title: "Contact", content: "For questions about these Terms, contact us at support@nawewellness.com." },
  ],
};
